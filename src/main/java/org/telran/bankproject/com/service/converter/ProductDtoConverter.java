...
public class ProductDtoConverter implements DtoConverter<Product, ProductDto> {
    ...
    public ProductDto toDto(Product product) {
        return new ProductDto(product.getId(),
                new ManagerDto(product.getManager().getId(), null, null, product.getManager()
                        .getFirstName(), product.getManager().getLastName(), product.getManager().getStatus()),
                new AgreementDto(product.getAgreement().getId(), null, null, product.getAgreement()
                        .getInterestRate(), product.getAgreement().getStatus(), product.getAgreement().getSum()),
                product.getName(), product.getCurrencyCode(), product.getInterestRate(), product.getProductLimit());
    }
