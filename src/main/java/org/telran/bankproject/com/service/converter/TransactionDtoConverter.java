...
public class TransactionDtoConverter implements DtoConverter<Transaction, TransactionDto> {
    ...
    public Transaction toEntity(TransactionDto transactionDto) {
        ...
        if (debitAccount == null) throw new EntityNotFoundException("Such debitAccount was not found in the database");
        if (credirAccount == null) throw new EntityNotFoundException("Such creditAccount was not found in the database");
